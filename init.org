...
#+BEGIN_SRC emacs-lisp
  ...
  (if (and (eq system-type 'windows) (getenv "HOME") (file-directory-p (getenv "HOME")))
      (cd (getenv "HOME")))
#+END_SRC
...
Enable the Emacs timestamp feature. When this feature is active, the
...
#+BEGIN_SRC emacs-lisp
  ...
  (unless (fboundp 'org-element-update-syntax)
