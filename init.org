...
#+AUTHOR: Tammy Cravit
#+DATE: Time-stamp: <2020-03-30 11:34:32 tammy.cravit>
#+BABEL: :cache yes
...
#+begin_src emacs-lisp
  ...
  ; Key bindings from https://ebzzry.io/en/emacs-pairs/
...
Include sunrise and sunset in the diary. From [[https://orgmode.org/worg/org-hacks.html#org6abe7b1][here]]. 

#+begin_src emacs-lisp
(setq calendar-latitude 33.454550)
(setq calendar-longitude -112.055730)
...
#+begin_src emacs-lisp
  (defun tlc/maybe-wrap-quotes (content &optional wrap-type)
    ...
    (if content
       (concat "#+begin_" (downcase (or wrap-type "quote")) "\n"
        content "\n"
        "#+end_" (downcase (or wrap-type "quote"))))
      "")
...
#+RESULTS:
| t  | Tasks   |       |                                        |                                       |
| tr | Respond | entry | (file+olp master.org Capacity Manager) | * NEXT Respond to %:from on %:subject |
