...
#+AUTHOR: Tammy Cravit
#+DATE: Time-stamp: <2020-03-12 14:15:09 tammy.cravit>
#+BABEL: :cache yes
...
#+begin_src emacs-lisp
  ...
  (use-package doct       :quelpa (doct       :fetcher github :repo "progfolio/doct"))
  (use-package org-jekyll :quelpa (org-jekyll :fetcher github :repo "juanre/org-jekyll"))
  (use-package ts         :quelpa (ts         :fetcher github :repo "alphapapa/ts.el"))
  (use-package s          :quelpa (s          :fetcher github :repo "magnars/s.el"))
  (use-package org-protocol-capture-html 
    :quelpa (org-protocol-capture-html :fetcher github 
