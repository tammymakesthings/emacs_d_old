...
#+DATE: Time-stamp: <2021-09-21 09:23:14 tammy>
#+BABEL: :cache yes
...
#+begin_src emacs-lisp
  (setq org-default-notes-file (file-truename (concat org-directory "/codex.org")))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "\C-c =") 'tlc/open-org-files)
#+end_src
...
7/02/2020 Anniversary: Mindbody separation
7/27/2020 Anniversary: Started at BCBSAZ
11/2/1998 Anniversary: Transition
4/19/1945 Birthday: Dad
6/04/1959 Birthday: Cynthia
8/04/1977 Birthday: Joanna
10/21/1973 Birthday: Me
10/22/2017 Birthday: Charlie
11/03/1946 Birthday: Mom
12/29/1940 Birthday: Irwin
...
%%(tlc/diary-weekday-entry "9:30am" "Collaboration Time")
%%(tlc/diary-weekday-entry "10:00am" "Gatos de Datos DSU" nil '("Friday")
#+end_src
...
#+begin_src emacs-lisp
  (defun tlc/org-publish-transformation2e-fm (plist filename pubdir)
    (tlc/org-publish-and-rename-latex
     (concat org-dir "/transformation_2e/tex/transformation_2e.tex")
     (concat org-dir "/transformation_2e/tex/transformation_2e_frontmatter.tex")
     plist filename pubdir))
  
  (defun tlc/org-publish-transformation2e-main (plist filename pubdir)
    (tlc/org-publish-and-rename-latex
     (concat org-dir "/transformation_2e/tex/transformation_2e.tex")
     (concat org-dir "/transformation_2e/tex/transformation_2e_main.tex")
     plist filename pubdir))
  
  (defun tlc/org-publish-transformation2e-em (plist filename pubdir)
    (tlc/org-publish-and-rename-latex
     (concat org-dir "/transformation_2e/tex/transformation_2e.tex")
     (concat org-dir "/transformation_2e/tex/transformation_2e_endmatter.tex")
     plist filename pubdir))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-publish-project-alist
               '("transformation2e_fm"
                 :base-directory (concat org-dir "/transformation_2e")
                 :publishing-directory (concat org-dir "/transformation_2e/tex")
...
#+begin_src emacs-lisp
  (defun tlc/org-publish-azmystery1-fm (plist filename pubdir)
    (tlc/org-publish-and-rename-latex
     (concat org-dir "/az_mystery_1/tex/az_mystery_1.tex")
     (concat org-dir "/az_mystery_1/tex/az_mystery_1_frontmatter.tex")
     plist filename pubdir))
  
  (defun tlc/org-publish-azmystery1-main (plist filename pubdir)
    (tlc/org-publish-and-rename-latex
     (concat org-dir "/az_mystery_1/tex/az_mystery_1.tex")
     (concat org-dir "/az_mystery_1/tex/az_mystery_1_main.tex")
     plist filename pubdir))
  
  (defun tlc/org-publish-azmystery1-em (plist filename pubdir)
    (tlc/org-publish-and-rename-latex
     (concat org-dir "/az_mystery_1/tex/az_mystery_1.tex")
     (concat org-dir "/az_mystery_1/tex/az_mystery_1_endmatter.tex")
     plist filename pubdir))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-publish-project-alist
               '("azmystery1_fm"
                 :base-directory (concat org-dir "/az_mystery_1")
                 :publishing-directory (concat org-dir "/az_mystery_1/tex")
...
#+begin_src emacs-lisp :tangle settings-system-ltXXXX.el
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;; System-specific settings - work laptop (LTXXXX)
  ;; Tangled from init.org - do not modify directly
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (provide 'settings-system-ltXXXXX)
